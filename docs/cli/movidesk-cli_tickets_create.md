...
Cria um chamado a partir de corpo JSON, template ou substituições --set
...
```
  ...
  -h, --help                        help for create
      --return-all                  pede ao Movidesk pra retornar o chamado completo
      --set strings                 sobrescreve campos, ex.: --set type=2 --set subject=Olá
```
